...
public class BusinessOperations implements FileInterface {
	...
	File[] files = new File("C:\\Users\\Admin\\workspace\\LockedMe Project").listFiles();
	@Override
	...
	public void addFile() {
		...
		try {
			if(F.createNewFile()) {
				...
				System.out.println("Already the file is there");
			}
		} catch (IOException e) {
	...
	public void searchFile() {
		...
		try {	
			Scanner scan= new Scanner(System.in);
			File directory = new File("C:\\Users\\Admin\\workspace\\LockedMe Project");
